    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.CharField(choices=[('agriculteur', 'agriculteur'), ('admin', 'admin'), ('utilisateur', 'utilisateur')], max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forum_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Compte.forum')),
